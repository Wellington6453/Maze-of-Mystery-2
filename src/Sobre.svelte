...
<div class="screen">
  ...
  <div class="scroll-area">
    <div class="container">
      ...
      <div class="card">
        <p class="text">
          Fazendo o joguin por pura diversão e para entregar na materia de design.
        </p>

        <div class="links">
          <a href="https://github.com/Pancosta" target="_blank" rel="noopener" class="link">
            Gustavo Pancosta de Oliveira
          </a>
